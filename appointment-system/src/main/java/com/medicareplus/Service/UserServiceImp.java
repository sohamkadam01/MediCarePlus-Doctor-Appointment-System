...
public class UserServiceImp implements UserService {
    ...
    public User registerDoctor(User user) {
        ...
        adminActivityService.log(
                "DOCTOR_REGISTERED",
                "New doctor registered: " + saved.getName(),
                saved.getRole().name(),
                saved.getId(),
                saved.getName(),
                "DOCTOR",
    ...
    public User approveDoctor(Integer doctorId) {
        ...
        DoctorDetails details = doctorDetailsRepository.findByUserId(doctorId)
                .orElseThrow(() -> new RuntimeException("Doctor details not submitted yet"));
